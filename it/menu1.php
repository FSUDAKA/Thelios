...
<?php
    if (($_SESSION['droit'] == 1) && ($_GET["idColaborateur"] != "")) { ?>
        ...
        <a href="deconnexion.php" id="deconnexion">Disconnettersi</a>
    <?php } elseif ($_SESSION['id'] !== null) { ?>
        ...
        ?>
        <?php if ($_GET["event"] == "") {
            echo '<a href="deconnexion.php" id="deconnexion">Disconnettersi</a>';
        } else {
            echo '<a href="./deconnexion.php" id="deconnexion">Disconnettersi</a>';
        } ?>
    <?php } else { ?>
        ...
        <a href="profil.php" id="deconnexion">Iscriviti</a>
...
<a href="../it" data-lang="it" class="iconlang"><img src="images/it.png" style=""></a>
        ...
        <a href="profil.php" id="deconnexion" trad-ref='inscription'>Iscriviti</a>
