    ...
    <body>
        ...
        <section id="one" class="wrapper align-center" style="margin-bottom: 100px;">
            <div class="inner">
                        ...
                        <h2 id="content" style="color:#f99f1b; font-size: 38px; line-height: 38px; margin-top: 50px;">Il tuo hotel</h2>

                        <p style="font-size:20px; text-align: center;">
                            <strong>Il nome e l'indirizzo dell'hotel vi verranno comunicati poco dopo.</strong>
                        </p>
            </div>
