			...
			<section id="one" class="wrapper align-center">
				<div class="inner">
					...
					<div class="row uniform">
                        ...
                        <h2 id="content" style="color:#f99f1b; margin-bottom: 5px; font-size: 44px; line-height: 44px;">Contact PRESSE, merci de vous adresser à :</h2>
                            <img src="images/article-onze.png" style="width: 200px; margin-top: 40px;"><br>
                        Delphine Beauchesne<br>Tél. : 01 55 60 24 45, dbeauchesne@articleonze.com
                        </div>
                     ...
                     ?>
                        ...
                        <div class="4u 12u$(small)">
                            <div class="row uniform">
                                ...
                                <?php if($dataEvt[$PIC] != ""){ ?>
                                <ul class="actions" style="float:left;"><li><a class="button special" data-fancybox data-type="iframe" data-src="images/<?php echo $event."/".$dataEvt[$PIC]; ?>">TÉLÉCHARGER</a></li></ul>
                                <?php } ?>
                            </div>
					    </div>
