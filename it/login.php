...
else{$error = "La combinazione nome utente/password non è corretta!";}
...
<html style="height:100%;">
	<head>
		<title>Accesso - Thélios Spring Convention 2021</title>
		<meta charset="utf-8" />
				...
				<div id="page_connect">
					...
					<div id="connexion">
						<form action="login.php" method="post" id="connect_form">
							...
							<input type="password" name="connect" id="connect" value="" placeholder="Password" class="12u$" style="margin-bottom:20px; color:#1e2336;">
							<input type="submit" value="Accesso" class="special" name="connexion">
						</form>
					</div>
					<p><a href="forget.php" style="color: #000;">Hai dimenticato la password ?</a></p>
