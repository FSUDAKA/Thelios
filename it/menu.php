...
<?php if($dataGeneral['OPT_ACCUEIL'] == 1){echo '<a class="mobileee" href="accueil.php'; if($_GET["event"] != ""){echo "?event=".$_GET["event"]."&view=admin";} echo'">Presentazione</a>';} ?>
...
<a href="deconnexion.php" id="deconnexion" class="onlymobile">Disconnettersi</a>
<?php }else{ ?>
<?php if ($_SESSION['id'] !== null) { ?>
<?php if(($_GET["view"] != "") || ($_SESSION['droit'] != 1)){echo '<a id="deconnexion" style="margin-bottom: 0.75em;" href="profil.php'; if($_GET["event"] != ""){echo "?event=".$_GET["event"];} echo'" class="onlymobile">Iscriviti</a>';} ?>
...
?>
<?php if($_GET["event"] == ""){echo '<a href="deconnexion.php" id="deconnexion" class="onlymobile">Disconnettersi</a>';}else{echo '<a href="#" id="deconnexion" class="onlymobile">Disconnettersi</a>';} ?>
<?php }else{ ?>

        <a href="profil.php" id="deconnexion" class="onlymobile">Iscriviti</a>
<?php } ?>
<?php } ?>