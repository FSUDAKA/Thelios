...
else{$error = "The username / password combination is incorrect !";}
...
<html style="height:100%;">
	<head>
		<title>Login - Thélios Spring Convention 2021</title>
		<meta charset="utf-8" />
				...
				<div id="page_connect">
					...
					<div id="connexion">
						<form action="login.php" method="post" id="connect_form">
							...
							<input type="submit" value="Login" class="special" name="connexion">
						</form>
					</div>
					<p><a href="forget.php" style="color: #000;">Forgot your password ?</a></p>
