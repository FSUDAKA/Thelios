...
if (($_SERVER['REQUEST_METHOD'] == 'POST') && isset($_POST['forget'])){
	...
	if(mysqli_num_rows($sql) >= 1){
		...
		while($data = mysqli_fetch_assoc($req)) {
            ...
            $email = $data["EMAIL"];
            $objet = 'Thélios Spring Convention 2021 - Modification of information';
            $titre = "Modification of information";
            $texte .= '<strong>Hello '.$prenom.' '.$nom.', </strong><br><br>You asked to recover your password.<br>Here is a new password : <strong style="color:#000;">'.$mdp.'</strong><br><br>';
            $texte .= "\r\n";
             
            include('class/Email.php');
			$error = "Your password has just been sent to your e-mail.";
		}
	}else{
		$error = "Your e-mail is not saved in the database.";
	}
...
<html style="height:100%;">
	<head>
		<title>Forgot your password ? - Thélios Spring Convention 2021</title>
		<meta charset="utf-8" />
		...
		<!-- Banner -->
			<section id="banner" style="background-image: url('images/bg_black.jpg'); height:100%;">
				<div id="page_connect">
					...
					<h1 style="color: #000;">Forgot your password ?</h1>
					<div id="connexion">
						<form action="forget.php" method="post" id="forget_form">
							...
							<input type="submit" value="Resend my password" class="special" name="forget">
						</form>
					</div>
					<p><a href="login.php" style="color: #000;">Return to the login page</a></p>
