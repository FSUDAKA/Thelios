...
<body>
    ...
    <section id="one" class="wrapper align-center">
		<div class="inner">
			...
			<p style="font-size:20px; text-align: center;">
				...
				<strong>Horaires d’ouverture : </strong>De 9h à 20h<br>
				<strong>Lieu : </strong>Cassina, Showroom Milano, Via Durini 16, 20122 Milano<br>
			</p>
			<h2 id="content" style="color:#f99f1b; font-size: 38px; line-height: 38px;">Contact</h2>
			<p style="font-size:20px; text-align: center;">
				<strong>Mail :</strong> events@thelios.com<br>
				<strong>Numéro de téléphone :</strong> +33 6 73 22 61 62
			</p>
		</div>
    </section>
    ...
    <section id="ten" class="wrapper align-center bloclock">
        ...
        <div class="inner">
            ...
            <h3></h3>
            <h2 id="content">Compte à rebours</h2>
