				...
				<div class="inner">
					...
					<div class="row uniform">
						...
						<div class="9u 12u$(small)" style="width: 100%">
							...
							<h2 id="content" style="color:#f99f1b; font-size: 38px; line-height: 38px; margin-top: 50px;">Données personnelles</h2>

							<p>
                                Les informations recueillies sur ce site sont enregistrées dans un fichier informatisé par AREP-Exigences pour la gestion des inscriptions pour le compte de Thélios.<br>
                                Ces informations peuvent servir à la gestion des événements et des appels à projets de Thélios. Elles ne seront pas cédées à d’autres organismes.<br>
