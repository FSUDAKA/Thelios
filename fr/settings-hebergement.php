...
if (($_SERVER['REQUEST_METHOD'] == 'POST') && isset($_POST['valider'])){
    ...
    $TXT_HEBERGEMENT_ST = $_POST['TXT_HEBERGEMENT_ST'];
    ...
    for ($i = 1; $i <= $NB_HEBERGEMENT; $i++) {
        ...
        $TXT_HEBERGEMENT_TITRE_CONTENT = $_POST['TXT_HEBERGEMENT_H'.$i.'_TITRE'];
        $TXT_HEBERGEMENT = "TXT_HEBERGEMENT_H".$i;
        $TXT_HEBERGEMENT_CONTENT = $_POST['TXT_HEBERGEMENT_H'.$i];
        $MAP_HEBERGEMENT_H = "MAP_HEBERGEMENT_H".$i;
        $MAP_HEBERGEMENT_CONTENT = $_POST['MAP_HEBERGEMENT_H'.$i];
